...
fig.subplots_adjust(left=0.07, right=0.97, bottom=0.38, top=0.93, wspace=0.15)
...
fig.legend(handles, labels, loc='lower center', bbox_to_anchor=(0.5, 0.0),
           ...
           columnspacing=1.0, handletextpad=0.4, fontsize=24, title_fontsize=25)
fig.savefig(os.path.join(_FIGDIR, "paper_km_rescaled_renfe.png"), dpi=300, bbox_inches="tight")
fig.savefig(os.path.join(_FIGDIR, "paper_km_rescaled_renfe.pdf"), bbox_inches="tight")
...
fig2.savefig(os.path.join(_FIGDIR, "paper_km_rescaled_intervals.png"), dpi=300, bbox_inches="tight")
fig2.savefig(os.path.join(_FIGDIR, "paper_km_rescaled_intervals.pdf"), bbox_inches="tight")
