...
plt.tight_layout()
fig.savefig(os.path.join(_FIGDIR, "waiting_time_fit_combined.png"), dpi=300, bbox_inches="tight")
fig.savefig(os.path.join(_FIGDIR, "waiting_time_fit_combined.pdf"), bbox_inches="tight")
print("SAVED")
